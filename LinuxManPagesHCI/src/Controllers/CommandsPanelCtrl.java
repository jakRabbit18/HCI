...
public class CommandsPanelCtrl extends MouseAdapter {
	...
	UCommand command;
	JPanel argsPanel, selectionPanel;
	JTextPane textPane;
	String category;
	
	public CommandsPanelCtrl(UCommand command, String category, JTextPane textPane, JPanel selectionPanel, JPanel argsPanel) {
	...
	public void mousePressed(MouseEvent e){
		...
		for(UArg arg: command.getArgs()){
			...
			butt.addMouseListener(new ArgsPanelCtrl(command, arg, textPane));
			argsPanel.add(butt);
		}
